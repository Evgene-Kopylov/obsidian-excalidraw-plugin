...
export default {
  ...
  LIBRARY_MIGRATION_TITLE: "將 Excalidraw 素材庫移入儲存庫",
  LIBRARY_MIGRATION_DESC:
    "Excalidraw 可將素材庫儲存為獨立的儲存庫檔案，而不是放在 data.json 中，讓儲存更穩定。現有素材會與所選本機素材庫檔案合併；放入同一資料夾的 *.excalidrawlib 檔案也會載入。選擇「稍後」可將此訊息隱藏到明天。",
  LIBRARY_MIGRATION_SYNC_WARNING:
    "若要透過 Obsidian Sync 同步素材庫檔案，請在同步設定中啟用「同步所有其他檔案類型」。",
  LIBRARY_MIGRATION_KEEP_DATA_JSON: "繼續使用 data.json",
  LIBRARY_MIGRATION_LATER: "稍後",
  LIBRARY_MIGRATION_MIGRATE: "移動素材庫",
  LIBRARY_MIGRATION_SUCCESS: "Excalidraw 素材庫已移入儲存庫。",
  LIBRARY_MIGRATION_FAILED: "無法移動素材庫。原 data.json 素材庫保持不變。",
  LIBRARY_FILE_READ_ERROR: "無法讀取 Excalidraw 素材庫檔案：{PATH}",
  LIBRARY_STORAGE_NAME: "素材庫儲存位置",
  LIBRARY_STORAGE_DESC: "將素材庫移出 data.json 並使用儲存庫檔案可提升穩定性。",
  LIBRARY_STORAGE_VAULT: "儲存庫資料夾（建議）",
  LIBRARY_STORAGE_DATA_JSON: "外掛 data.json（舊方式）",
  LIBRARY_FOLDER_NAME: "素材庫資料夾",
  LIBRARY_FOLDER_DESC:
    "用於存放本機素材庫和下載的素材庫檔案。素材庫檔案使用 .excalidrawlib 副檔名。要在 Obsidian 檔案列表中查看這些檔案，請在 Obsidian 設定中啟用「顯示所有檔案類型」。",
  LIBRARY_FILE_NAME: "本機素材庫檔名",
  LIBRARY_FILE_DESC: "可編輯本機素材庫的名稱。副檔名會自動加入。",
  LIBRARY_MIGRATE_NOW: "立即移動素材庫",
  LIBRARY_MIGRATE_NOW_DESC: "將 data.json 中的現有素材庫移到設定的儲存庫檔案。",
  LIBRARY_PATH_MISSING: "此路徑目前不存在於儲存庫中。",
  CREATE_FOLDER: "建立資料夾",
  CREATE_FOLDER_CONFIRM: "是否建立資料夾 <b>{PATH}</b>？",
  CREATE_FOLDER_NEVER_MIND: "暫不建立",
  CREATE_FOLDER_YES: "是",
  CREATE_FOLDER_SUCCESS: "已建立資料夾：{PATH}",
  CREATE_FOLDER_FAILED: "無法建立資料夾：{PATH}",
  CREATE_FOLDER_PATH_IS_FILE: "無法建立資料夾，該路徑已有檔案：{PATH}",
  OPEN_SIDEPANEL: "開啟 Excalidraw 側邊面板",
  OPEN_EXISTING_NEW_PANE: "開啟已有的繪圖 - 於新面板",
  OPEN_EXISTING_ACTIVE_PANE: "開啟已有的繪圖 - 於當前面板",
  TRANSCLUDE: "嵌入繪圖 ![[drawing]] 到當前 Markdown 文件中",
  TRANSCLUDE_MOST_RECENT:
    "嵌入最近編輯過的繪圖 ![[drawing]] 到當前 Markdown 文件中",
  ...
  NEW_IN_NEW_PANE_EMBED: "新建繪圖 - 於新面板 - 並嵌入到當前 Markdown 文件中",
  NEW_IN_NEW_TAB_EMBED: "新建繪圖 - 於新標籤頁 - 並嵌入到當前 Markdown 文件中",
  ...
  INSERT_LINK_TO_ELEMENT: `單擊=複製所選元素的 [[file#^id]] 連結\n${labelCTRL()}=複製元素所在分組為 [[file#^group=id]] 連結\n${labelSHIFT()}=複製所選元素所在區域為 [[file#^area=id]] 連結`,
  INSERT_LINK_TO_ELEMENT_GROUP:
    "複製所選元素所在分組為 ![[file#^group=id]] 連結",
  INSERT_LINK_TO_ELEMENT_AREA: "複製所選元素所在區域為 ![[file#^area=id]] 連結",
  INSERT_LINK_TO_ELEMENT_FRAME: "複製所選畫框為 ![[file#^frame=id]] 連結",
  ...
  INSERT_MARKDOWN_IMAGE: "插入可編輯的 Markdown 圖像",
  EDIT_MARKDOWN_IMAGE: "編輯 Markdown 圖像",
  MARKDOWN_IMAGE_SELECT_ERROR: "請選擇一個 Markdown 圖像後重試",
  MARKDOWN_IMAGE_TITLE: "Markdown 圖像",
  MARKDOWN_IMAGE_INSERT_ERROR: "無法插入 Markdown 圖像",
  ...
  MARKDOWN_IMAGE_TRANSCLUSION_APPEARANCE: "嵌入內容外觀",
  MARKDOWN_IMAGE_TRANSCLUSION_APPEARANCE_DESC:
    "啟用後，這些設定將套用於此 Markdown 圖像中的 ![[嵌入文字]]。",
  MARKDOWN_IMAGE_TRANSCLUSION_CSS: "嵌入內容 CSS",
  MARKDOWN_IMAGE_TRANSCLUSION_CSS_DESC: "僅套用於嵌入 Markdown 的 CSS 規則。",
  MARKDOWN_IMAGE_SET_DEFAULT: "設為預設",
  MARKDOWN_IMAGE_SAVE_DEFAULT_ARIA: "將目前外觀設定儲存為預設值",
  MARKDOWN_IMAGE_DEFAULT_SAVED: "Markdown 圖像預設設定已儲存",
  MARKDOWN_IMAGE_RENDER_NOW: "立即渲染",
  MARKDOWN_IMAGE_UPDATING: "正在更新圖像…",
  MARKDOWN_IMAGE_EXTERNAL_SOURCE: "外部 Markdown 來源",
  MARKDOWN_IMAGE_OPEN_EXTERNAL_SOURCE_NEW_TAB:
    "在新分頁中開啟外部 Markdown 來源",
  MARKDOWN_IMAGE_MAKE_LOCAL: "建立本機副本",
  MARKDOWN_IMAGE_EXTERNAL_TARGET: "外部筆記、標題或區塊",
  MARKDOWN_IMAGE_EXTERNAL_DESC: "輸入 Obsidian 連結作為外部來源",
  MARKDOWN_IMAGE_USE_SOURCE: "使用來源",
  MARKDOWN_IMAGE_EXTRACT_LOCAL: "將本機 Markdown 擷取到筆記",
  MARKDOWN_IMAGE_EXTRACT: "擷取到筆記",
  MARKDOWN_IMAGE_DUPLICATE_ERROR: "無法複製 Markdown 圖像",
  MARKDOWN_IMAGE_SELECT_SOURCE: "請選擇 Markdown 筆記、標題或區塊",
  ...
  MARKDOWN_IMAGE_FOCUS_OWNER: "聚焦所屬的 Excalidraw 文件：{file}",
  MARKDOWN_IMAGE_OWNER_UNAVAILABLE: "所屬的 Excalidraw 文件已無法使用。",
  MARKDOWN_IMAGE_RESIZE_EDITOR: "調整 Markdown 編輯器大小",
  CONVERT_EMBEDDABLE_TO_MARKDOWN_IMAGE: "轉換為 Markdown 圖像",
  CONVERT_MARKDOWN_IMAGE_TO_EMBEDDABLE: "轉換為嵌入內容",
  MARKDOWN_IMAGE_CONVERSION_ERROR: "無法轉換 Markdown 內容。",
  ...
  INSERT_LATEX: `插入 LaTeX 公式到當前繪圖中`,
  ...
  ARIA_LABEL_TRAY_MODE:
    "切換 3 種 UI 模式：完整模式（桌面端）、緊湊模式、托盤模式。手機端只有手機端模式。",
  ...
  FILENAME_INVALID_CHARS: '檔名不能包含以下符號： * " \\ < > : | ? #',
  FORCE_SAVE: "儲存（同時更新嵌入了該繪圖的 Markdown 文件）",
  RAW: "正以 RAW 模式顯示連結\n點選切換到 PREVIEW 模式",
  PARSED: "正以 PREVIEW 模式顯示連結\n點選切換到 RAW 模式",
  NOFILE: "Excalidraw（沒有檔案）",
  COMPATIBILITY_MODE:
    "*.excalidraw 是相容舊版的繪圖檔案格式。需要轉換為新格式才能解鎖本外掛的全部功能。",
  CONVERT_FILE: "轉換為新格式",
  BACKUP_AVAILABLE:
    "載入繪圖檔案時出錯，可能是由於 Obsidian 在上次儲存時意外退出了（移動裝置上更容易發生這種意外）。<br><br><b>好訊息：</b>這臺裝置上存在備份。您是否想要恢復本裝置上的備份？<br><br>（我建議您先嚐試在最近使用過的其他裝置上開啟該繪圖，以檢查是否有更新的備份。）",
  BACKUP_SAVE_AS_FILE:
    "此繪圖為空。但有一個非空的備份可用。您想將其恢復為新檔案並在新標籤頁中開啟嗎？",
  BACKUP_SAVE: "恢復",
  BACKUP_DELETE: "刪除備份",
  BACKUP_CANCEL: "取消",
  CACHE_NOT_READY:
    "抱歉，載入繪圖檔案時出錯。<br><br><mark>現在有耐心，將來更省心。</mark><br><br>外掛有備份機制，但您似乎剛開啟 Obsidian，需要等待一分鐘或更長的時間來讀取快取。快取讀取完畢時，您會在右上角收到通知。<br><br>請點選 OK 並耐心等待，或者，選擇點選取消後手動修復檔案。<br>",
  OBSIDIAN_TOOLS_PANEL: "Obsidian 工具面板",
  ERROR_SAVING_IMAGE:
    "獲取圖片時發生未知錯誤。可能是由於某種原因，圖片不可用或拒絕了 Obsidian 的獲取請求。",
  ...
  SAVE_IS_TAKING_VERY_LONG:
    "為了更好的效能，請考慮將大型繪圖拆分成幾個較小的檔案。",

  //ContentSearcher.ts
  SEARCH_COPIED_TO_CLIPBOARD: "Markdown 內容已複製到剪貼簿",
  SEARCH_COPY_TO_CLIPBOARD_ARIA:
    "將整個設定對話方塊以 Markdown 格式複製到剪貼簿。適合與 ChatGPT 等工具配合使用進行搜尋和理解。",
  ...
  CROP_SUFFIX_DESC:
    "裁剪影像時建立的新繪圖檔名的最後部分。" + "如果不需要字尾，請留空。",
  CROP_PREFIX_NAME: "裁剪檔案的字首",
  CROP_PREFIX_DESC:
    "裁剪影像時建立的新繪圖檔名的第一部分。" + "如果不需要字首，請留空。",
  ANNOTATE_SUFFIX_NAME: "標註檔案的字尾",
  ANNOTATE_SUFFIX_DESC:
    "標註影像時建立的新繪圖檔名的最後部分。" + "如果不需要字尾，請留空。",
  ANNOTATE_PREFIX_NAME: "標註檔案的字首",
  ANNOTATE_PREFIX_DESC:
    "標註影像時建立的新繪圖檔名的第一部分。" + "如果不需要字首，請留空。",
  ...
  FOLDER_EMBED_NAME: "將 Excalidraw 資料夾用於“新建繪圖”系列命令",
  FOLDER_EMBED_DESC:
    "在命令面板中執行“新建繪圖”系列命令時，" +
    "新建的繪圖檔案的儲存路徑。<br>" +
  ...
  AI_USAGE_MODAL_SESSION_NOTE: "僅合計當前 Obsidian 會話用量，重啟後將重置。",
  ...
  FILENAME_DATE_DESC: "檔名的最後一部分。允許留空。",
  ...
  DISPLAY_EDITOR_PREVIEWS_HEAD: "編輯與預覽",
  DISPLAY_EDITOR_PREVIEWS_DESC:
    "設定畫布編輯手勢，以及 Excalidraw 檔案在閱讀模式和懸停預覽中的顯示方式。",
  ...
  DYNAMICSTYLE_DESC: "根據繪圖顏色自動調整 Excalidraw 介面顏色",
  ...
  SHOW_DRAWING_OR_MD_IN_READING_MODE_NAME:
    "Markdown 模式的 Excalidraw 在閱讀模式將渲染為影像",
  SHOW_DRAWING_OR_MD_IN_READING_MODE_DESC:
    ...
    `請參閱餘下部分中與 <a href='#${
      TAG_MDREADINGMODE
    }'>Markdown Reading 模式</a> 相關的其他設定。<br>` +
    `⚠️ 關閉並重新開啟 Excalidraw/Markdown 檔案後生效。`,
  SHOW_DRAWING_OR_MD_IN_EXPORTPDF_NAME:
    "在 Obsidian 中匯出為 PDF 時 Excalidraw 將渲染為圖片",
  ...
  MODES_HEAD: "UI 模式",
  MODES_DESC:
    "選擇不同裝置的 Excalidraw 介面配置、標題列控制項和左右手托盤位置。",
  ...
  HOTKEY_OVERRIDE_GROUP_DESC:
    "管理應優先於衝突 Obsidian 熱鍵的 Excalidraw 按鍵組合。",
  HOTKEY_OVERRIDE_CONTROL_NAME: "管理熱鍵覆蓋",
  HOTKEY_OVERRIDE_DESC:
    `一些 Excalidraw 的熱鍵，如 ${labelCTRL()}+Enter 用於編輯文字，或 ${labelCTRL()}+K 用於建立元素連結，` +
  ...
  THEME_HEAD: "主題和樣式",
  THEME_DESC:
    "控制介面樣式、繪圖和嵌入主題、開啟模式以及行動裝置安全區域間距。",
  ...
  ZOOM_STEP_NAME: "縮放增量",
  ZOOM_STEP_DESC:
    "執行縮放操作時，每次縮放的百分比增量。該值越小，控制精度越高，但完成同樣的縮放需要操作更多次。預設：5%。",
  ZOOM_MIN_NAME: "最小縮放",
  ZOOM_MIN_DESC:
    "繪圖縮小（顯示更多內容）的極限。預設：10%。低於 10% 可能不穩定——謹慎調低，出現問題請重置為 10%。",
  ZOOM_MAX_NAME: "最大縮放",
  ZOOM_MAX_DESC:
    "繪圖放大的極限。預設：3000%。通常無需修改，考慮完整性而提供。",
  PEN_HEAD: "手寫筆",
  PEN_DESC: "設定自動手寫筆模式、觸控手勢、橡皮擦和自由繪製十字線。",
  GRID_HEAD: "網格",
  GRID_DESC: "設定網格方向、自動或自訂顏色以及不透明度。",
  ...
  LINKS_HEAD:
    "連結 & 待辦任務（Todo）& 嵌入到繪圖中的 Markdown 文件（MD-Transclusion）",
  LINKS_HEAD_DESC:
    "包括：連結的開啟和顯示，Todo 的顯示，MD-Transclusion 的顯示等。",
  LINKS_DESC:
  ...
  DRAG_MODIFIER_GROUP_DESC:
    "設定連結開啟手勢，以及點擊和拖放操作的平台特定修飾鍵組合。",
  LINK_OPENING_GESTURES_HEAD: "連結開啟手勢",
  LINK_OPENING_GESTURES_DESC:
    "設定嵌入繪圖和檢視模式中的長按延遲與雙擊開啟連結。",
  WEB_BROWSER_DRAG_ACTION_DESC:
    "選擇從網頁瀏覽器拖入連結、圖片、匯入項目和嵌入內容時的修飾鍵組合。",
  LOCAL_FILE_DRAG_ACTION_DESC:
    "選擇從作業系統拖入連結、圖片、匯入項目和嵌入內容時的修飾鍵組合。",
  INTERNAL_DRAG_ACTION_DESC:
    "選擇在 Obsidian 內拖動連結、圖片、完整尺寸圖片和嵌入內容時的修飾鍵組合。",
  PANE_TARGET_DESC: "選擇決定點擊連結開啟位置的修飾鍵組合。",
  MODIFIER_KEY_USAGE_NAME: "設定修飾鍵",
  MODIFIER_KEY_COMBINATIONS: "修飾鍵組合",
  DRAG_MODIFIER_DESC:
    `在您按住點選連結或拖動元素時，可以觸發某些行為。您可以為這些行為新增修飾鍵。` +
    ...
    `選項裡的 4 個開關依次代表 ${
      DEVICE.isIOS || DEVICE.isMacOS
        ...
        : "Shift, Ctrl, Alt, Meta (Win 鍵)。"
    }`,
  LONG_PRESS_DESKTOP_NAME: "長按開啟（電腦端）",
  LONG_PRESS_DESKTOP_DESC:
    "長按開啟在 Markdown 文件中嵌入的 Excalidraw 繪圖。單位：毫秒。",
  ...
  ELEMENT_LINK_SYNC_DESC:
    "若開啟，Excalidraw 將匹配 2.19.0 之前的行為：始終將正文第一個連結複製到元素連結欄位。匯出 SVG/PNG 僅在元素連結欄位包含單個連結（不包括正文內的連結）時保留連結。開啟：若你依賴正文連結並希望元素連結始終映象第一個連結。關閉：若你獨立管理元素連結，用於標籤、行內連結本體等元資料、或多個連結，如 Dataview 風格的筆記 '(reminds me of:: [[link]]) #noteToSelf'。",
  FOCUS_ON_EXISTING_TAB_NAME: "聚焦於當前標籤頁",
  FOCUS_ON_EXISTING_TAB_DESC:
    "當開啟一個連結時，如果該檔案已經開啟，Excalidraw 將會聚焦到現有的標籤頁上。" +
  ...
  PARSE_TODO_DESC:
    "將文字元素中的 <code>- [ ]</code> 和 <code>- [x]</code> 字首顯示為方框。",
  TODO_NAME: "未完成專案",
  ...
  LINK_CTRL_CLICK_NAME: `按住 ${labelCTRL()} 並點選含有 [[連結]] 或 [別名](連結) 的文字來開啟連結`,
  ...
  LINK_BEHAVIOR_HEAD: "連結行為",
  LINK_BEHAVIOR_DESC:
    "設定連結同步、相關連結、懸停預覽、點擊處理和網頁標題查詢。",
  LINK_USAGE_NAME: "在 Excalidraw 中使用連結",
  LINK_OPENING_HEAD: "窗格和分頁行為",
  LINK_OPENING_DESC:
    "選擇連結是否重複使用、聚焦或切換窗格、分頁和主要工作區。",
  LINK_APPEARANCE_HEAD: "連結外觀",
  LINK_APPEARANCE_DESC: "設定連結顯示時使用的括號、前綴、圖示和不透明度。",
  TODO_HEAD: "待辦事項",
  TODO_GROUP_DESC: "設定待辦事項解析以及未完成和已完成任務使用的圖示。",
  TRANSCLUSION_HEAD: "文字嵌入",
  TRANSCLUSION_DESC:
    "設定嵌入 Markdown 文字的字元限制、換行和引用符號清理。",
  PDF_TO_IMAGE: "以影像形式嵌入到繪圖中的 PDF",
  PDF_TO_IMAGE_SCALE_NAME: "解析度",
  PDF_TO_IMAGE_SCALE_DESC:
    "解析度越高，影像越清晰，但記憶體佔用也越大。" +
    "此外，如果您想要複製這些影像到 Excalidraw.com，可能會超出其 2MB 大小的限制。",
  EMBED_TOEXCALIDRAW_HEAD: "嵌入到繪圖中的檔案",
  EMBED_TOEXCALIDRAW_DESC:
    "包括：以影像形式嵌入到繪圖中的 PDF、以互動或影像形式嵌入到繪圖中的 Markdown 文件等。",
  MD_HEAD: "以影像形式嵌入到繪圖中的 Markdown 文件（MD-Embed）",
  MD_GROUP_DESC:
    "設定以影像呈現的 Markdown 檔案之尺寸、字型、顏色、邊框和 CSS。",
  MD_EMBED_CUSTOMDATA_HEAD_NAME:
    "以互動形式嵌入到繪圖中的 Markdown 文件（MD-Embeddable）",
  MD_EMBED_CUSTOMDATA_GROUP_DESC:
    "設定未來互動式 Markdown 嵌入的編輯方式和預設外觀。",
  MD_EMBED_DEFAULTS_CONTROL_NAME: "互動式 Markdown 預設外觀",
  ...
  MD_TRANSCLUDE_HEIGHT_NAME: "MD-Embed 的預設最大高度",
  ...
  MD_DEFAULT_FONT_NAME: "MD-Embed 的預設字型",
  ...
  EMBED_PREVIEW_LINKS_HEAD: "預覽、連結與 Canvas",
  EMBED_PREVIEW_LINKS_DESC:
    "選擇預覽和插入檔案的格式、來源連結行為、預留影像及沉浸式 Canvas 嵌入。",
  ...
  EMBED_CACHING_DESC:
    "調整平行渲染和本機圖片快取、清除快取圖片或備份，並可重用已匯出的預覽。",
  ...
  EXPORT_SUBHEAD: "匯出",
  EXPORT_SUBHEAD_DESC:
    "設定 PDF 渲染、匯出的場景資料、影像尺寸、主題與背景、PDF 預設值及自動 PNG/SVG 副本。",
  EMBED_SIZING: "影像尺寸",
  EMBED_SIZING_DESC: "設定嵌入影像的預設尺寸、PNG 縮放比例和匯出邊距。",
  ...
  EMBED_REUSE_EXPORTED_IMAGE_NAME: "將之前已匯出圖片作為預覽圖",
  EMBED_REUSE_EXPORTED_IMAGE_DESC:
    `該項與下方“匯出”部分“匯出設定”中的 <a href='#${
      TAG_AUTOEXPORT
    }'>自動匯出 SVG/PNG 副本</a> 選項配合使用。如果嵌入到 Markdown 文件中的繪圖檔案存在同名的 SVG/PNG 副本，則將其作為預覽圖，而不再重新生成。<br>` +
    ...
    `該項無法提升繪圖檔案的開啟速度。詳見 <a href="${URLs.GITHUB_COM_ZSVICZIAN_OBSIDIAN_EXCALIDRAW_PLUGIN_RELEASES_TAG}/1.6.23" target='_blank'>此說明</a>。`,
  ...
  PDF_EXPORT_SETTINGS_DESC:
    "選擇預設 PDF 頁面大小、方向、分頁、邊距、紙張顏色和對齊方式。",
  PDF_EXPORT_DEFAULTS_CONTROL_NAME: "預設 PDF 匯出配置",
  EXPORT_HEAD: "匯出設定",
  EXPORT_AUTOEXPORT_DESC:
    "保持匯出檔案同步，並自動建立 SVG、PNG、淺色和深色版本。",
  SETTINGS_NAVIGATION_OPEN: "開啟",
  SETTINGS_BREADCRUMB_ARIA: "設定路徑",
  SETTINGS_RELATED_AUTOEXPORT_DESC:
    "啟用自動 PNG 或 SVG 副本，使這些格式可在插入檔案類型下拉清單中選擇。",
  SETTINGS_RELATED_EMBED_TYPE_DESC:
    "選擇在文件中嵌入繪圖時插入 Excalidraw、PNG 還是 SVG。",
  ...
  DUMMY_TEXT_ELEMENT_LINT_SUPPORT_DESC:
    "Excalidraw 對 <code># Excalidraw Data</code> 下的檔案結構非常敏感。文件的自動格式化可能會在 Excalidraw 資料中造成錯誤。" +
  ...
  EXPORT_EXCALIDRAW_DESC:
    "和“自動匯出 SVG 副本”類似，但是匯出格式為 *.excalidraw。",
  SYNC_EXCALIDRAW_NAME: "新舊格式繪圖檔案的內容保持同步",
  ...
  LATEX_DEFAULT_DESC:
    "允許留空。允許使用類似 <code>\\color{white}</code> 的格式化表示式。",
  LATEX_PREAMBLE_NAME: "LaTeX 前言檔案（區分大小寫！）",
  LATEX_PREAMBLE_DESC:
    "前言檔案的完整路徑，留空則使用預設值。如果檔案不存在，該項將被忽略。<br><strong>重要：</strong>更改後需要重新載入 Obsidian 才能生效！",
  ...
  MAX_IMAGE_ZOOM_IN_DESC:
    "為節省記憶體，並且因為 Apple Safari (Obsidian on iOS) 存在硬編碼的限制，Excalidraw.com 在放大時會限制圖片和大型物件的最大解析度。您可以設定一個倍數來覆蓋這個限制。" +
  ...
  ES_LOCKED_READING_MODE_DESC:
    "開啟後，與 MD-Embeddable 互動時不會自動切換到編輯模式。可用於待辦列表和習慣追蹤。",
  ...
  ES_BACKGROUND_DESC_DETAIL:
    "背景色僅影響預覽模式的 MD-Embeddable。在編輯模式，它會根據場景（透過筆記屬性設定）或外掛設定，遵循 Obsidian 的深色/淺色主題。背景色有兩層：元素背景色（下層顏色）和上層顏色。選擇“匹配元素”表示兩層都遵循元素背景色。選擇“匹配繪圖”或特定背景色不會改變元素背景色。設定不透明度（如 50%）會將繪圖或所選顏色與元素背景色混合。要移除元素背景色，可以在 Excalidraw 的元素屬性編輯器中將元素背景色設定為透明，這樣只有上層顏色生效。",
  ...
  ES_PROPERTIES_VISIBLE_DESC:
    "在嵌入檔案頂部顯示筆記屬性（YAML frontmatter）。",
  ES_PROPERTIES_VISIBLE_WARNING:
    "全域性 Obsidian 設定已隱藏筆記屬性。請先更改為“顯示”或“原始碼”。",
  ...
  LINK_CLICK_MD_PROPS:
    "顯示 Markdown 圖片屬性對話方塊（僅在以影像形式嵌入 Markdown 文件時適用）",
  ...
  EXPORTDIALOG_IMAGE_DESC:
    "PNG 支援透明。外部檔案可以包含 Excalidraw 場景資料。",
  ...
  EXPORTDIALOG_NOT_AVAILALBE:
    "抱歉，此功能僅在繪圖在主 Obsidian 工作區開啟時可用。",
  ...
  UIFM_ANCHOR_DESC:
    "這是一個專業功能，請在瞭解其作用的情況下再使用。啟用後，即使你在 Excalidraw 中調整了匯入影像的大小，下次開啟繪圖時，該影像仍會恢復為原始大小的 100%。當你將一個獨立的 Excalidraw 點子嵌入到另一份筆記中，並希望保持文字和圖示的相對尺寸時，這會很有用。",
...
`,
  ...
  VERSION_MISMATCH_CAUSE:
    "通常源於同步不完整，大檔案未能同步（如使用 Obsidian Sync Standard，main.js > 5MB），只更新了 <code>manifest.json</code>。",
  VERSION_MISMATCH_OPTIONS:
    "選項：<br><b>1.</b> 重新下載外掛（推薦）。<br><b>2.</b> 暫時忽略。",
  VERSION_MISMATCH_NOTE:
    "注意：手動更新版本資訊可能會影響依賴 manifest.json 的工具（如 Plugin Update Tracker、BRAT），直到你完全重灌外掛。",
  VERSION_MISMATCH_DISABLE_NAME: "停用版本不匹配警告",
  VERSION_MISMATCH_DISABLE_DESC:
    "可在以下位置重新啟用：設定 → Excalidraw → 基本 → 警告外掛更新不完整",
  ...
  EXTRAS_GATEWAY_DESC:
    "“{component}”功能已移動至配套外掛 Excalidraw Extras，以保持外掛精簡，避免超出 Obsidian Sync 的大小限制，並讓您更明確地控制所需的擴充套件庫及高許可權功能。",
  EXTRAS_GATEWAY_INSTALL_BTN: "從社群外掛安裝",
  EXTRAS_GATEWAY_MANUAL_ENABLE_NOTICE:
    "我原本實現了根據需要自動啟停 Excalidraw Extras 的工作流，但因被 Obsidian 程式碼掃描器標記為高風險項而被迫移除，儘管我認為相關程式碼被誤判了。目前您需要手動啟用 Excalidraw Extras。如果您希望未來有更便捷的體驗，請考慮向 Obsidian 官方建議，為安全的自動化工作流提供支援。",
  ...
  EXTRAS_GATEWAY_FEATURE_TIMER_EXPIRED:
    "Excalidraw Extras: {component} 計時器到期，功能已停用。",
  EXTRAS_GATEWAY_API_MISSING:
    "Excalidraw Extras 已啟用，但 API 載入失敗。請更新該外掛。",
  EXTRAS_GATEWAY_FEATURE_TITLE: "功能已停用",
  EXTRAS_GATEWAY_FEATURE_DESC:
    "“{component}”功能目前在您的 Excalidraw Extras 設定中處於停用狀態。",
  EXTRAS_GATEWAY_IGNORE_SESSION: "在本次會話忽略",
  EXTRAS_GATEWAY_UPDATE_EXACT:
    "需要更新 Excalidraw Extras。{component} 功能需要版本 = v{reqVersion} (當前為 v{currentVersion})。",
